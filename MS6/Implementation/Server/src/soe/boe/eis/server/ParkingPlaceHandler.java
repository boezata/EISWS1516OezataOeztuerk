	...
	private void process() throws IOException {
		...
		while (running) {
			...
			if (sCommand.startsWith("#013")) {
				...
				if (response == Enums.decreaseOfNumberOfFreeParkingPlacesSuccesFull) {
					conout.println("#011");
				} else {
					conout.println("#012");
				}
				...
				if (response == Enums.increaseOfNumberOfFreeParkingPlacesSuccesFull) {
					conout.println("#011");
				} else {
					conout.println("#012");
				}
				...
				try {
					...
					if (response == Enums.settingOfNumberOfFreeParkingPlacesSuccesFull) {
						conout.println("#011");
					} else {
						conout.println("#012");
					}
